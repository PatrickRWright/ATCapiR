...
"Use this template" button or use [this link](https://github.com/PatrickRWright/ATCapiR/generate)
...
You will also need to search and replace all occurences of `ATCapiR` with
